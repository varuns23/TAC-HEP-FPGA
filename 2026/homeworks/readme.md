...
- Pragma's to choose from: Interface, Array parition, Array reshape, pipeline, dataflow, allocation, latency, inline, stable, loop unroll, loop_flatten, loop_merge, loop_tripcount
